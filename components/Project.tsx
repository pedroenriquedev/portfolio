...
const Project = (props: IProps) => {
  ...
  return (
    <div className={`${props.backend ? 'bg-limeGreen' : 'bg-light' } w-full text-dark px-8 py-4 rounded tracking-tight mb-12`}>
        <div className={props.backend ? 'grid grid-cols-2' : ''}>
            ...
            <div className='ml-4'>
                <div className='flex flex-col justify-between h-full'>
                    ...
                    <Button isExternal={true} text='demo' url={props.demo} isDark={true} fontColor={props.backend ? 'limeGreen' : 'light'}  icon={RxExternalLink} />
